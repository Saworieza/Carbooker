class StoreCarsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @store_car.save
        ...
        format.json { render :show, status: :created, location: @store_car }
      else
  ...
  def update
    respond_to do |format|
      if @store_car.update(store_car_params)
        ...
        format.json { render :show, status: :ok, location: @store_car }
      else
  ...
  def destroy
    @store_car.destroy
    respond_to do |format|
      format.html { redirect_to store_cars_url, notice: 'Store car was successfully destroyed.' }
